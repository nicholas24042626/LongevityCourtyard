...
function header(slug){return `<header class="site-header"><div class="nav-canvas"><a class="brand" href="index.html" aria-label="Longevity Courtyard home"><img src="assets/images/d3785a90c69bb02a1026498fd15e24ba8c36ef10.png" alt="Longevity Courtyard, in collaboration with HUR and Tzu Chi"></a><button class="menu-toggle" aria-controls="main-navigation" aria-expanded="false" aria-label="Open navigation"><span></span><span></span><span></span></button><nav id="main-navigation" aria-label="Main navigation">${[['Programmes','programmes'],['Fitness Team','fitness-team'],['Stories','stories'],['Equipment','resources']].map(([t,s])=>`<a href="${s}.html" ${slug===s?'aria-current="page"':''}>${t}</a>`).join('')}<div class="language-switch" aria-label="Language"><span lang="en" class="selected">English</span><button type="button" lang="zh" data-dialog="中文">中文</button></div><a class="visit-button" href="visit.html">Visit Us!</a></nav></div></header>`;}
